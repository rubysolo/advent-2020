...
parsePassports : String -> List PassportPolicy
...
parsePassport : String -> PassportPolicy
parsePassport input =
    let
        fields =
            String.words input
        ...
        heightUnit =
            Dict.get "hgt" data
                |> Maybe.withDefault "0xx"
                |> String.right 2

        height =
            case heightUnit of
                "cm" ->
                    Centimeter heightValue
    ...
    , eyr = intValue "eyr"
    , hgt = height
    , hcl = Dict.get "hcl" data |> Maybe.withDefault "invalid"
    , ecl = eyeColor
    , pid = Dict.get "pid" data |> Maybe.withDefault "invalid"
    , cid = Dict.get "cid" data |> Maybe.withDefault "invalid"
    }


validatePassport : PassportPolicy -> Bool
validatePassport policy =
    True
