...
validatePolicy2 policy =
    let
        ...
        char1 =
            ...
            |> Maybe.withDefault '_' -- ridin' dirty
...
stringToChar str =
    case String.toList str of
        ...
        _ -> Parser.problem <| "Expected a single character, but got: " ++ str
...
parsePolicy =
    succeed PasswordPolicy
        ...
        |. symbol ":"
        |. spaces
        |= Parser.getChompedString (Parser.chompWhile Char.isLower) --password
